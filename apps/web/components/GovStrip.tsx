...
// Static and bilingual on purpose, so it is part of the prerendered shell. A labelled region,
// not a banner: the top bar below is the page's one banner.
export function GovStrip() {
  return (
    <div className="ks-gov" role="region" aria-label="Government of Maharashtra · महाराष्ट्र शासन">
